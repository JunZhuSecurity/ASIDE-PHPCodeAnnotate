...
public class Constants {
	...
	public static final Set<String> CONTROL_CHECK_FUNCTIONS = new HashSet<String>(Arrays.asList("require_capability", "has_capability"));
	public static final Set<String> SENSITIVE_FUNCTION_CALL_FOR_ANALYSIS = new HashSet<String>(Arrays.asList("insert_record", "delete_records", "update_record"));
